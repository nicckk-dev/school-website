...
const OtherOptionWithComment = ({ form, data }) => {
  ...
  useEffect(() => {
    if (data?.valuesData) {
      setIsOtherOptionsOpen(data.valuesData?.otherOption || data.valuesData?.otherOption2 || false);
  ...
  return (
    <div className="w-full p-2">
      <div>
        <Form.Item name="otherOption2" valuePropName="checked">
          <Checkbox
        ...
        <div className="p-4 d-flex flex-column gap-3">
          ...
          <div>
            <Form.Item name="rows">
              ...
              >
                <Radio value="commentForQuestion">
                  One comment for the question
                </Radio>
                <Radio value="commentPerRow">One comment per row</Radio>
              </Radio.Group>
            </Form.Item>
          </div>
          <div>
          ...
          {validation !== "none" && (
            <div>
              <Form.Item
                ...
                rules={[
                  { required: true, message: "Please enter error message" },
                ]}
              >
...
export default OtherOptionWithComment;
